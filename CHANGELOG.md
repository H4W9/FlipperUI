...
### Added
- GPIO entry in the side-rail navigation, placed below the libraries (after BadUSB, before Screen). Uses the Flipper-style GPIO pixel icon. View is currently a placeholder — content lands in a follow-up.
